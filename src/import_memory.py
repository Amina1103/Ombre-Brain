...
_EXTRACT_MAX_TOKENS = 8192      # Cyrus 定制：导入提取输出放宽（原 2048）
...
9. 在 content 中用「Amina」和「Cyrus」标注说话人；原文的「Claude」「AI」「assistant」一律写成「Cyrus」，「用户」「human」「user」一律写成「Amina」；禁止用代词替代
10. 如果原文中包含时间标记（如 [2026-05-15 14:30] 格式），必须原样保留在对应 content 的开头，不得省略或改写

输出格式（纯 JSON 数组，无其他内容）：
[
  {
    "name": "条目标题（10字以内）",
    "content": "[YYYY-MM-DD HH:MM] 整理后的内容",
    "domain": ["主题域1"],
    "valence": 0.7,
    "arousal": 0.4,
    "tags": ["核心词1", "核心词2", "扩展词1"],
